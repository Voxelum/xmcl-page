    ...
    <div class="flex gap-2 flex-wrap" :class="{
      ...
      <div class="ui labeled button" tabindex="0">
        <a deb class="ui huge inverted download positive labeled icon button w-full"
          :class="{ 'md:w-auto': !organized, 'md:w-[45%]': organized }" :disabled="artifacts.refreshing || !artifacts.deb"
      ...
      <div class="ui labeled button" tabindex="0">
        <a rpm class="ui huge inverted download labeled icon button w-full md:w-auto"
      ...
      <div class="ui labeled button" tabindex="0">
        <a appimage class="ui huge inverted download labeled icon red button w-full"
          ...
          :disabled="artifacts.refreshing || !artifacts.appImage" :href="artifacts.appImage"
