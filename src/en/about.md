...
hero:
  name: XMCL
  text: Discover different experiences about a Minecraft launcher.
  image:
    src: /logo.png
    alt: XMCL
  actions:
...
features:
  - icon: 📥
    title: Download & auto complete
    details: Support download Minecraft, Forge, Fabric, Quilt, OptiFine, JVM from official or third party mirrors.
  - icon: ⚡️
    title: Download Fast
    details: Reuse socket via HTTP/HTTPS agents, and download the files in parts concurrently.
  - icon: 💻
    title: Cross platform
    details: The launcher is based on Electron, and supports Windows 10/11, MacOS, and Linux.
  - icon: 📚
    title: Multi-Instancing
    details: Create multiple instances to isolate different versions, mods and launch settings.
  - icon: 🗂
    title: Manage all resources
    details: Use links to install resources in instances, keep your disk usage optimal.
  - icon: 🔥
    title: Built-in support of CurseForge & Modrinth
    details: Download resources directly inside the launcher.
...
If you want to add features or fix bugs, see [Contributing](/en/guide/contributing)

If you want to help translation, please follow [Getting Started with Localization](/en/guide/i18n).
...
| :----------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|                                        [![](/deno-logo.webp)](https://deno.com/deploy)                                         |        [Deno Deploy](https://deno.com/deploy), XMCL leverage its hassle-free platform for serverless JavaScript applications. Provided by [Deno](https://deno.com/)        |
...
The legacy project contributors:
