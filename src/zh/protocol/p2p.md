...
以下图表展示了如何协调 P2P 连接、完成 NAT 打洞以及在两个 Minecraft 客户端之间安全地建立游戏流量隧道：
...
<div>
<strong style="color: var(--vp-c-text-1); display: block; margin-bottom: 4px;">信令与房间建立</strong>
<p style="margin: 0; font-size: 0.9rem; color: var(--vp-c-text-2);">
<strong>房主</strong>发送 SDP Offer 到信令服务器（Lobby）。<br/><strong>客人</strong>获取 Offer，设置并向房主返回 SDP Answer。
</p>
</div>
</div>
<!-- Arrow -->
...
<div>
<strong style="color: var(--vp-c-text-1); display: block; margin-bottom: 4px;">NAT 穿透与打洞</strong>
<p style="margin: 0; font-size: 0.9rem; color: var(--vp-c-text-2);">
双方启动器通过 STUN/TURN 进行 NAT 打洞，以建立直接的 P2P 连接。开启可靠的元数据控制通道。
</p>
</div>
</div>
<!-- Arrow -->
...
<div>
<strong style="color: var(--vp-c-text-1); display: block; margin-bottom: 4px;">局域网游戏发现</strong>
<p style="margin: 0; font-size: 0.9rem; color: var(--vp-c-text-2);">
<strong>房主 Minecraft</strong> 广播其局域网世界。房主启动器将该元数据转发给客人。<br/><strong>客人启动器</strong>启动本地 TCP 代理，并将其作为假局域网游戏广播给客人的 Minecraft 客户端。
</p>
</div>
</div>
<!-- Arrow -->
...
<div>
<strong style="color: var(--vp-c-text-1); display: block; margin-bottom: 4px;">游戏流量隧道代理</strong>
<p style="margin: 0; font-size: 0.9rem; color: var(--vp-c-text-2);">
客人客户端连接 to 代理。客人启动器将连接映射到新的二进制 WebRTC DataChannel。房主启动器将数据包转发到实际的 Minecraft 服务器。
</p>
</div>
</div>
</div>
